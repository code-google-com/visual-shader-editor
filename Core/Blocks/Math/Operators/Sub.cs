...
{
    [Block(Name = "Sub", Path = "Math/Operators")]
    public class Sub : BaseBlock
    {
        public Sub(BlockManager owner)
            : base(owner, null)
        {
        ...
        {
            sc.AddInstruction(InstructionHelper.BinaryOperatorVector(BinaryExpression.Operators.Sub, Outputs[0].Variable, Inputs[0], Inputs[1]));
        }
    }
}
